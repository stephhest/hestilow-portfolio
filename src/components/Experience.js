              ...
              <div key={program.image} className="lg:w-1/3 lg:mx-auto w-100 p-4">
                ...
                <div className="inline-flex items-center">
                  <div className="group flex"></div>
                    ...
                    />
                    <div>
                      <h1 className="md:text-xl text-lg ml-3 font-medium text-white">
                        {program.institution}
                      </h1>
                      <h2 className="md:text-lg text-base ml-3 font-semibold text-blue-300">
                        {program.years}
                      </h2>
                    </div>
                  </div>
                  ...
                  <p className="md:text-base text-base text-white mt-4">
                    {program.description}
                  </p>
                </div>
              </div>
